...
const DispatchingSystemPage = () => {
  const technologies = [
    'Next.js 15', 'React 19', 'TypeScript', 'Tailwind CSS', 'Jest', 
  ...
  const features = [
    {
      ...
      description: 'Automated order processing, intelligent route planning, and real-time driver assignment'
    },
    {
    ...
    },
    {
      ...
      description: 'Comprehensive insights into dispatch efficiency and delivery KPIs with data visualization'
    }
  ]
            ...
            <div>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xl text-accent font-medium">Logistics Platform</p>
                </div>
              </div>
              
              <p className="text-lg text-text/80 mb-8 leading-relaxed">
                A comprehensive logistics and delivery management platform built with Next.js 15 and TypeScript, 
                designed to streamline dispatch operations, optimize delivery routes, and enhance real-time coordination. 
                It enables logistics companies to efficiently manage orders, drivers, fleets, and delivery performance.
              </p>
              ...
              <div className="flex items-center space-x-6">
                <Link
                  href="https://github.com/osamaqaseem39/dispatching-system"
                  target="_blank"
                ...
                <Link
                  href="https://dispatching-demo.vercel.app"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-accent/20 to-purple-500/20 rounded-2xl flex items-center justify-center border border-accent/20">
                <div className="text-center">
                  <Truck className="w-24 h-24 text-accent/50 mx-auto mb-4" />
                  <p className="text-text/60">Logistics Management Platform</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-accent/10 to-purple-500/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-4xl font-bold text-accent mb-2">Fleet</div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg text-text/80 max-w-none">
            <p className="mb-6">
              The Dispatching System aims to improve operational efficiency, reduce delivery times, and enhance 
              customer satisfaction through an intuitive and high-performance web interface. With features like 
              real-time tracking, automated driver assignment, and data-driven analytics, the system provides 
              comprehensive logistics management capabilities.
            </p>
            <p className="mb-6">
              The platform includes a communication system with real-time notifications, customer updates, and 
              emergency alerts via multiple channels. It features optimized performance with fast loading, image 
              optimization, and efficient resource handling using Next.js features for optimal user experience.
            </p>
            <p>
              Built with a scalable architecture that is modular, maintainable, and optimized for future integrations 
              like AI routing and IoT tracking. The system demonstrates expertise in logistics technology, real-time 
              coordination, and modern web development practices for enterprise-level logistics operations.
            </p>
          </div>
        </div>
      </section>
...
export default DispatchingSystemPage
