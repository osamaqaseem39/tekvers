...
const PunjabACPage = () => {
  const technologies = [
    ...
    'Custom Components', 'npm', 'ESLint', 'Prettier', 'Jest'
  ]
  ...
  const features = [
    {
      ...
      description: 'Rich text editor, categorization, tagging, media handling, version control, and approval workflow'
    },
    {
      icon: <Users2 className="w-6 h-6" />,
      title: 'Admin Dashboard',
      description: 'Overview of content performance, user management, media library, and system settings'
    },
    {
      icon: <Image className="w-6 h-6" />,
      title: 'Publishing & SEO',
      description: 'Scheduled publishing, SEO management, meta tags, custom URLs, and content templates'
    },
    {
      icon: <Search className="w-6 h-6" />,
      title: 'Performance Optimization',
      description: 'Image optimization, lazy loading, code splitting, and fast load times'
    }
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-text/80 mb-8 leading-relaxed">
                A modern content management system built with Next.js and TypeScript, designed to help businesses 
                and organizations efficiently create, organize, and publish digital content. The platform provides 
                a responsive admin dashboard, media management, content versioning, scheduling, and SEO tools.
              </p>
              ...
              <div className="flex items-center space-x-6">
                <Link
                  href="https://github.com/osamaqaseem39/punjab-ac"
                  target="_blank"
                ...
                <Link
                  href="https://punjab-ac-demo.vercel.app"
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <section className="py-16 bg-gradient-to-r from-accent/10 to-purple-500/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-accent mb-2">CMS</div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg text-text/80 max-w-none">
            <p className="mb-6">
              Punjab AC delivers a scalable, user-friendly solution for managing content across multiple channels 
              while optimizing performance and accessibility. Its primary goal is to provide comprehensive content management 
              capabilities with modern web technologies and intuitive user interfaces.
            </p>
            <p className="mb-6">
              The platform includes user experience with intuitive interface, preview functionality, responsive design, 
              and easy content navigation, along with future-ready features including multi-language support, advanced 
              analytics, API integration, mobile management, and AI-powered optimization.
            </p>
            <p>
              Built with performance optimization in mind, the system utilizes Next.js built-in features for image 
              optimization, lazy loading, code splitting, and minimized bundles for fast load times. The platform 
              demonstrates expertise in content management systems, modern web development, and scalable business solutions.
            </p>
          </div>
        </div>
      </section>
