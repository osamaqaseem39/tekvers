...
const AKTradersPage = () => {
  const technologies = [
    ...
    'Framer Motion', 'PostgreSQL', 'Prisma ORM', 'NextAuth.js', 'Nodemailer'
  ]
  ...
  const features = [
    {
      ...
      description: 'Real-time status updates and comprehensive tracking system for all shipments'
    },
    {
      icon: <Package className="w-6 h-6" />,
      title: 'Quote Management',
      description: 'Automated quote requests and management system for quick customer service'
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: 'Multi-Platform Dashboard',
      description: 'Comprehensive dashboards for Admin, Staff, and Clients with role-based access'
    },
    {
      icon: <MapPin className="w-6 h-6" />,
      title: 'Logistics Analytics',
      description: 'Key logistics metrics and performance analytics for operational optimization'
    }
  ]
            ...
            <div>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xl text-accent font-medium">Freight Forwarding & Customs Clearance</p>
                </div>
              </div>
              
              <p className="text-lg text-text/80 mb-8 leading-relaxed">
                A modern Next.js web application built for A.K. Traders, a leading freight forwarding and customs 
                clearance company operating in Pakistan since 1974. The platform delivers a complete digital 
                transformation of their logistics operations with advanced dashboard systems.
              </p>
              ...
              <div className="flex items-center space-x-6">
                <Link
                  href="https://github.com/osamaqaseem39/ak-traders"
                  target="_blank"
                ...
                <Link
                  href="https://ak-traders-demo.vercel.app"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-accent/20 to-purple-500/20 rounded-2xl flex items-center justify-center border border-accent/20">
                <div className="text-center">
                  ...
                  <p className="text-text/60">Freight Forwarding Platform</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-accent/10 to-purple-500/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-accent mb-2">1974</div>
              <div className="text-text/70">Years in Business</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-text/70">Role Access</div>
            </div>
            <div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg text-text/80 max-w-none">
            <p className="mb-6">
              The A.K. Traders platform enables shipment tracking, quote requests, invoice management, and content 
              publishing, all within a secure and user-friendly interface. Designed for scalability and performance, 
              it enhances business efficiency, client engagement, and overall operational transparency.
            </p>
            <p className="mb-6">
              The application features a modern public website for clients and an advanced dashboard system for 
              administrators, staff, and customers. It includes role-based authentication, analytics dashboards, and 
              comprehensive logistics management tools.
            </p>
            <p>
              Built with Next.js 15 and React 19, the platform showcases modern web development practices with 
              optimized performance, responsive design, and seamless user experience across all devices.
            </p>
          </div>
        </div>
      </section>
